...
public:
    OBJObject(char *objFileName, const OBJObjectShaderHandles &shaderHandles, const GLJoe::Transform &cMw, const GLJoe::Transform &wMo, OBJObjectParams *defaultShaderParams);
    ~OBJObject() {
        delete [] vertices;
        delete [] normals;
